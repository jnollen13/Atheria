...
import com.example.explomod.entity.npc.ModTraderTrades;
...
public class TraderEntity extends AbstractVillager{
    ...
    public TraderEntity(EntityType<? extends AbstractVillager> entityType, Level level) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector
                .addGoal(
                        ...
                        new UseItemGoal<>(
                                ...
                                p_352831_ -> this.level().isThundering() && !p_352831_.isInvisible()
                        )
                );
        this.goalSelector
                .addGoal(
        ...
        this.goalSelector.addGoal(1, new AvoidEntityGoal<>(this, Villager.class, 8.0F, 0.5, 0.5));
        this.goalSelector.addGoal(1, new AvoidEntityGoal<>(this, WanderingTrader.class, 8.0F, 0.5, 0.5));
        this.goalSelector.addGoal(1, new AvoidEntityGoal<>(this, Witch.class, 10.0F, 0.5, 0.5));
        this.goalSelector.addGoal(1, new AvoidEntityGoal<>(this, Slime.class, 8.0F, 0.5, 0.5));
        this.goalSelector.addGoal(1, new AvoidEntityGoal<>(this, Piglin.class, 8.0F, 0.5, 0.5));
        this.goalSelector.addGoal(1, new AvoidEntityGoal<>(this, PiglinBrute.class, 14.0F, 0.5, 0.5));
        this.goalSelector.addGoal(1, new AvoidEntityGoal<>(this, EnderMan.class, 8.0F, 0.5, 0.5));
        ...
        this.goalSelector.addGoal(0, new AvoidEntityGoal<>(this, Villager.class, 8.0F, 0.1, 0.1));
        ...
        this.goalSelector.addGoal(9, new FollowMobGoal(this, 0.2, 8.0F, 10.5f));
        this.goalSelector.addGoal(1, new PanicGoal(this, 0.95));
        this.goalSelector.addGoal(1, new LookAtTradingPlayerGoal(this));
        this.goalSelector.addGoal(2, new com.example.explomod.entity.custom.TraderEntity.WanderToPositionGoal(this, 2.0, 0.35));
        this.goalSelector.addGoal(3, new TraderEntity.SleepGoal());
    ...
    public InteractionResult mobInteract(Player player, InteractionHand hand) {
        ...
        if (!itemstack.is(Items.VILLAGER_SPAWN_EGG) && this.isAlive() && !this.isTrading() && !this.isBaby() && !this.isSleeping()) {
    ...
    protected void updateTrades() {
        if (this.level().enabledFeatures().contains(FeatureFlags.TRADE_REBALANCE)) {
            ...
            VillagerTrades.ItemListing[] avillagertrades$itemlisting = ModTraderTrades.TRADER_TRADES.get(1);
            VillagerTrades.ItemListing[] avillagertrades$itemlisting1 = ModTraderTrades.TRADER_TRADES.get(2);
    ...
    public boolean isSleeping() {
        return this.getSharedFlag(32);
    }

    void setSleeping(boolean sleeping) {
        this.setSharedFlag(32, sleeping);
    }
    ...
    class WanderToPositionGoal extends Goal {
        final com.example.explomod.entity.custom.TraderEntity trader;
        final double stopDistance;
        final double speedModifier;

        WanderToPositionGoal(TraderEntity trader, double stopDistance, double speedModifier) {
            this.trader = trader;
        ...
        public void stop() {
            ...
            com.example.explomod.entity.custom.TraderEntity.this.navigation.stop();
        }
        ...
        public void tick() {
            BlockPos blockpos = this.trader.getWanderTarget();
            if (blockpos != null && com.example.explomod.entity.custom.TraderEntity.this.navigation.isDone()) {
                if (this.isTooFarAway(blockpos, 10.0)) {
                    ...
                    com.example.explomod.entity.custom.TraderEntity.this.navigation.moveTo(vec31.x, vec31.y, vec31.z, this.speedModifier);
                } else {
                    com.example.explomod.entity.custom.TraderEntity.this.navigation.moveTo((double)blockpos.getX(), (double)blockpos.getY(), (double)blockpos.getZ(), this.speedModifier);
                }
            }
        }
    ...
    class SleepGoal extends Goal {
        ...
        public SleepGoal() {
            this.countdown = TraderEntity.this.random.nextInt(WAIT_TIME_BEFORE_SLEEP);
        }
        ...
        private boolean canSleep() {
            if (this.countdown > 0) {
                ...
                return TraderEntity.this.level().isDay();
            }
        }

        public void stop() {
            TraderEntity.this.countdown = TraderEntity.this.random.nextInt(WAIT_TIME_BEFORE_SLEEP);
            TraderEntity.this.clearStates();
        }

        public void start() {
            TraderEntity.this.setSleeping(true);
        }
    }

    public class TraderEntityBehaviorGoal {
    }

    public boolean wantsToPickUp(ItemStack stack) {
        return stack.is(Items.EMERALD_BLOCK) ? false : super.wantsToPickUp(stack);
    }
}