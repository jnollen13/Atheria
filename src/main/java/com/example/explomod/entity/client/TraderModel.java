...
public class TraderModel<T extends TraderEntity> extends HierarchicalModel<T> {
    ...
    @Override
    public void setupAnim(TraderEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        this.root().getAllParts().forEach(ModelPart::resetPose);
        this.applyHeadRotation(netHeadYaw, headPitch);

        this.animateWalk(TraderAnimations.WALKING, limbSwing, limbSwingAmount, 2f, 1.0f);
    }
