...
public class BossGrassGolemModel<T extends BossGrassGolem> extends HierarchicalModel<T> {
    ...
    public BossGrassGolemModel(ModelPart root) {
    ...
    @Override
    public void setupAnim(@NotNull BossGrassGolem entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
