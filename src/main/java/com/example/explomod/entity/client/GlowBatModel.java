...
@OnlyIn(Dist.CLIENT)
public class GlowBatModel<G extends AmbientCreature> extends HierarchicalModel<GlowBat> {
    public static final ModelLayerLocation LAYER_LOCATION =
            new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(ExploMod.MODID, "glow_bat"), "main");
    ...
    public GlowBatModel(ModelPart root) {
     ...
     */
    public void setupAnim(GlowBat entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
